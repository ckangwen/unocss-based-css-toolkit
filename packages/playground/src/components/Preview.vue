...
<template>
  ...
  >
    ...
    >
      <div
        class="absolute -mt-4 h-4 w-full flex items-center justify-center bg-light-700 dark:bg-dark-800"
      >
      ...
      >
        <span
          ...
          i-la-grip-lines
          text-gray-400
          class="-rotate-45 -mt-1 -ml-1"
        />
      </div>
      <div
        class="absolute left-0 bottom-0 -ml-4 -mb-4 h-4 w-4 flex items-center justify-center bg-light-700 dark:bg-dark-800"
      >
        <span
          w-4
          h-4
          i-la-grip-lines
          text-gray-400
          class="rotate-45 -mt-1 -mr-1"
        />
      </div>
      <div
        class="absolute top-0 left-0 -ml-4 -mt-4 h-4 w-4 flex items-center justify-center bg-light-700 dark:bg-dark-800"
      >
        <span
          w-4
          h-4
          i-la-grip-lines
          text-gray-400
          class="rotate-135 -mb-1 -mr-1"
        />
      </div>
      <div
        class="absolute top-0 right-0 -mr-4 -mt-4 h-4 w-4 flex items-center justify-center bg-light-700 dark:bg-dark-800"
      >
        <span
          w-4
          h-4
